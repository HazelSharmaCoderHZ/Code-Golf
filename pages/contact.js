...
export default function Contact() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-purple-900 via-purple-600 to-blue-900 text-white px-8 py-16 flex flex-col items-center justify-center">
      ...
      <div className="max-w-4xl text-lg  text-purple-200 bg-black border border-white rounded-xl p-10  hover:border-pink-300 hover:scale-110 duration-300 space-y-6">
